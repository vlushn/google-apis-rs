...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/vectortile1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](SemanticTile) ... 
//! 
//! * featuretiles
//!  * [*get*](api::FeaturetileGetCall)
//! * terraintiles
//!  * [*get*](api::TerraintileGetCall)
//! 
//! 
//! 
//! 
