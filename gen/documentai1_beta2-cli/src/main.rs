...
use google_documentai1_beta2::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
    async fn _projects_documents_batch_process(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudDocumentaiV1beta2BatchProcessDocumentsRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().documents_batch_process(request, opt.value_of("parent").unwrap_or(""));
    ...
    async fn _projects_documents_process(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudDocumentaiV1beta2ProcessDocumentRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().documents_process(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_documents_batch_process(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudDocumentaiV1beta2BatchProcessDocumentsRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_documents_batch_process(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_documents_process(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::GoogleCloudDocumentaiV1beta2ProcessDocumentRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_documents_process(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    let arg_data = [
        ("projects", "methods: 'documents-batch-process', 'documents-process', 'locations-documents-batch-process', 'locations-documents-process', 'locations-operations-get' and 'operations-get'", vec![
            ...
            ("documents-process",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_documentai1_beta2_cli/projects_documents-process",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-documents-process",
                    Some(r##"Processes a single document."##),
                    "Details at http://byron.github.io/google-apis-rs/google_documentai1_beta2_cli/projects_locations-documents-process",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Target project and location to make a call. Format: `projects/{project-id}/locations/{location-id}`. If no location is specified, a region will be chosen automatically. This field is only populated when used in ProcessDocument method."##),
