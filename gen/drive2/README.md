...
You may alter the way an `doit()` method is called by providing a [delegate](https://docs.rs/google-drive2/2.0.9+20210322/google_drive2/client::Delegate) to the 
