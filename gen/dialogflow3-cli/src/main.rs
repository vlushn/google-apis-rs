        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["avatar-uri", "default-language-code", "description", "display-name", "enable-speech-adaptation", "enable-spell-correction", "enable-stackdriver-logging", "name", "security-settings", "speech-to-text-settings", "start-flow", "time-zone"]);
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["description", "display-name", "name", "update-time"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["condition", "create-time", "definition", "description", "display-name", "end-time", "experiment-length", "last-update-time", "name", "result", "start-time", "state"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["agent-uri"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "transition-route-groups" => Some(("transitionRouteGroups", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Vec })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["display-name", "entry-fulfillment", "name", "tag", "transition-route-groups", "webhook"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["disabled", "display-name", "generic-web-service", "name", "password", "request-headers", "timeout", "uri", "username"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["display-name", "inspect-template", "name", "purge-data-types", "redaction-scope", "redaction-strategy", "retention-window-days"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-agents-create', 'locations-agents-delete', 'locations-agents-entity-types-create', 'locations-agents-entity-types-delete', 'locations-agents-entity-types-get', 'locations-agents-entity-types-list', 'locations-agents-entity-types-patch', 'locations-agents-environments-create', 'locations-agents-environments-delete', 'locations-agents-environments-experiments-create', 'locations-agents-environments-experiments-delete', 'locations-agents-environments-experiments-get', 'locations-agents-environments-experiments-list', 'locations-agents-environments-experiments-patch', 'locations-agents-environments-experiments-start', 'locations-agents-environments-experiments-stop', 'locations-agents-environments-get', 'locations-agents-environments-list', 'locations-agents-environments-lookup-environment-history', 'locations-agents-environments-patch', 'locations-agents-environments-sessions-detect-intent', 'locations-agents-environments-sessions-entity-types-create', 'locations-agents-environments-sessions-entity-types-delete', 'locations-agents-environments-sessions-entity-types-get', 'locations-agents-environments-sessions-entity-types-list', 'locations-agents-environments-sessions-entity-types-patch', 'locations-agents-environments-sessions-fulfill-intent', 'locations-agents-environments-sessions-match-intent', 'locations-agents-export', 'locations-agents-flows-create', 'locations-agents-flows-delete', 'locations-agents-flows-get', 'locations-agents-flows-get-validation-result', 'locations-agents-flows-list', 'locations-agents-flows-pages-create', 'locations-agents-flows-pages-delete', 'locations-agents-flows-pages-get', 'locations-agents-flows-pages-list', 'locations-agents-flows-pages-patch', 'locations-agents-flows-patch', 'locations-agents-flows-train', 'locations-agents-flows-transition-route-groups-create', 'locations-agents-flows-transition-route-groups-delete', 'locations-agents-flows-transition-route-groups-get', 'locations-agents-flows-transition-route-groups-list', 'locations-agents-flows-transition-route-groups-patch', 'locations-agents-flows-validate', 'locations-agents-flows-versions-create', 'locations-agents-flows-versions-delete', 'locations-agents-flows-versions-get', 'locations-agents-flows-versions-list', 'locations-agents-flows-versions-load', 'locations-agents-flows-versions-patch', 'locations-agents-get', 'locations-agents-get-validation-result', 'locations-agents-intents-create', 'locations-agents-intents-delete', 'locations-agents-intents-get', 'locations-agents-intents-list', 'locations-agents-intents-patch', 'locations-agents-list', 'locations-agents-patch', 'locations-agents-restore', 'locations-agents-sessions-detect-intent', 'locations-agents-sessions-entity-types-create', 'locations-agents-sessions-entity-types-delete', 'locations-agents-sessions-entity-types-get', 'locations-agents-sessions-entity-types-list', 'locations-agents-sessions-entity-types-patch', 'locations-agents-sessions-fulfill-intent', 'locations-agents-sessions-match-intent', 'locations-agents-test-cases-batch-delete', 'locations-agents-test-cases-batch-run', 'locations-agents-test-cases-calculate-coverage', 'locations-agents-test-cases-create', 'locations-agents-test-cases-export', 'locations-agents-test-cases-get', 'locations-agents-test-cases-import', 'locations-agents-test-cases-list', 'locations-agents-test-cases-patch', 'locations-agents-test-cases-results-get', 'locations-agents-test-cases-results-list', 'locations-agents-test-cases-run', 'locations-agents-validate', 'locations-agents-webhooks-create', 'locations-agents-webhooks-delete', 'locations-agents-webhooks-get', 'locations-agents-webhooks-list', 'locations-agents-webhooks-patch', 'locations-operations-cancel', 'locations-operations-get', 'locations-operations-list', 'locations-security-settings-create', 'locations-security-settings-delete', 'locations-security-settings-get', 'locations-security-settings-list', 'locations-security-settings-patch', 'operations-cancel', 'operations-get' and 'operations-list'", vec![
            ("locations-agents-create",
                    Some(r##"Creates an agent in the specified location."##),
            ...
            ("locations-agents-entity-types-create",
                    Some(r##"Creates an entity type in the specified agent."##),
            ...
            ("locations-agents-entity-types-delete",
                    Some(r##"Deletes the specified entity type."##),
            ...
            ("locations-agents-entity-types-patch",
                    Some(r##"Updates the specified entity type."##),
            ...
            ("locations-agents-environments-create",
                    Some(r##"Creates an Environment in the specified Agent."##),
            ...
            ("locations-agents-environments-patch",
                    Some(r##"Updates the specified Environment."##),
            ...
            ("locations-agents-export",
                    Some(r##"Exports the specified agent to a binary file."##),
            ...
            ("locations-agents-flows-create",
                    Some(r##"Creates a flow in the specified agent."##),
            ...
            ("locations-agents-flows-pages-create",
                    Some(r##"Creates a page in the specified flow."##),
            ...
            ("locations-agents-flows-pages-delete",
                    Some(r##"Deletes the specified page."##),
            ...
            ("locations-agents-flows-pages-patch",
                    Some(r##"Updates the specified page."##),
            ...
            ("locations-agents-flows-patch",
                    Some(r##"Updates the specified flow."##),
            ...
            ("locations-agents-flows-train",
                    Some(r##"Trains the specified flow. Note that only the flow in 'draft' environment is trained."##),
            ...
            ("locations-agents-flows-transition-route-groups-create",
                    Some(r##"Creates an TransitionRouteGroup in the specified flow."##),
            ...
            ("locations-agents-flows-transition-route-groups-delete",
                    Some(r##"Deletes the specified TransitionRouteGroup."##),
            ...
            ("locations-agents-flows-transition-route-groups-patch",
                    Some(r##"Updates the specified TransitionRouteGroup."##),
            ...
            ("locations-agents-flows-versions-create",
                    Some(r##"Creates a Version in the specified Flow."##),
            ...
            ("locations-agents-flows-versions-load",
                    Some(r##"Loads a specified version to draft version."##),
                    "Details at http://byron.github.io/google-apis-rs/google_dialogflow3_cli/projects_locations-agents-flows-versions-load",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The Version to be loaded to draft version. Format: `projects//locations//agents//flows//versions/`."##),
                     Some(true),
                     Some(false)),
            ...
            ("locations-agents-intents-create",
                    Some(r##"Creates an intent in the specified agent."##),
            ...
            ("locations-agents-intents-delete",
                    Some(r##"Deletes the specified intent."##),
            ...
            ("locations-agents-intents-patch",
                    Some(r##"Updates the specified intent."##),
            ...
            ("locations-agents-patch",
                    Some(r##"Updates the specified agent."##),
            ...
            ("locations-agents-restore",
                    Some(r##"Restores the specified agent from a binary file. Replaces the current agent with a new one. Note that all existing resources in agent (e.g. intents, entity types, flows) will be removed."##),
            ...
            ("locations-agents-test-cases-batch-run",
                    Some(r##"Kicks off a batch run of test cases."##),
            ...
            ("locations-agents-test-cases-export",
                    Some(r##"Exports the test cases under the agent to a Cloud Storage bucket or a local file. Filter can be applied to export a subset of test cases."##),
            ...
            ("locations-agents-test-cases-import",
                    Some(r##"Imports the test cases from a Cloud Storage bucket or a local file. It always creates new test cases and won't overwite any existing ones. The provided ID in the imported test case is neglected."##),
            ...
            ("locations-agents-test-cases-run",
                    Some(r##"Kicks off a test case run."##),
