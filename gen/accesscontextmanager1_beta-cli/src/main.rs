...
impl<'n> Engine<'n> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "title" => Some(("title", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["name", "parent", "title"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "title" => Some(("title", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["access-levels", "allowed-services", "description", "enable-restriction", "name", "perimeter-type", "resources", "restricted-services", "status", "title", "unrestricted-services", "vpc-accessible-services"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "accesscontextmanager1-beta-secret.json",
    ...
    let arg_data = [
        ("access-policies", "methods: 'access-levels-create', 'access-levels-delete', 'access-levels-get', 'access-levels-list', 'access-levels-patch', 'create', 'delete', 'get', 'list', 'patch', 'service-perimeters-create', 'service-perimeters-delete', 'service-perimeters-get', 'service-perimeters-list' and 'service-perimeters-patch'", vec![
            ("access-levels-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_access-levels-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("access-levels-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_access-levels-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("access-levels-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_access-levels-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. Resource name for the Access Level. Format: `accessPolicies/{policy_id}/accessLevels/{access_level_id}`"##),
            ...
            ("access-levels-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_access-levels-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("access-levels-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_access-levels-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_create",
                  vec![
                    (Some(r##"kv"##),
                     Some(r##"r"##),
                     Some(r##"Set various fields of the request structure, matching the key=value form"##),
            ...
            ("delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_list",
                  vec![
                    (Some(r##"v"##),
                     Some(r##"p"##),
                     Some(r##"Set various optional parameters, matching the key=value form"##),
            ...
            ("patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("service-perimeters-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_service-perimeters-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("service-perimeters-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_service-perimeters-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("service-perimeters-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_service-perimeters-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("service-perimeters-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_service-perimeters-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("service-perimeters-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/access-policies_service-perimeters-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        ("operations", "methods: 'get'", vec![
            ("get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_accesscontextmanager1_beta_cli/operations_get",
                  vec![
                    (Some(r##"name"##),
                     None,
