...
You may alter the way an `doit()` method is called by providing a [delegate](https://docs.rs/google-dialogflow2/2.0.9+20210329/google_dialogflow2/client::Delegate) to the 
