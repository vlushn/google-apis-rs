...
use google_deploymentmanager2_beta2::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    "intent" => Some(("intent", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "manifest" => Some(("manifest", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "name" => Some(("name", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "state" => Some(("state", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "target.config" => Some(("target.config", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "update.errors" => Some(("update.errors", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Vec })),
                    "update.manifest" => Some(("update.manifest", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    "update-time" => Some(("updateTime", JsonTypeInfo { jtype: JsonType::String, ctype: ComplexType::Pod })),
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["config", "description", "errors", "fingerprint", "id", "insert-time", "intent", "manifest", "name", "state", "target", "update", "update-time"]);
    ...
    async fn _deployments_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            match key {
                "update-policy" => {
                    call = call.update_policy(value.unwrap_or(""));
                },
                "delete-policy" => {
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["create-policy", "delete-policy", "update-policy"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "deploymentmanager2-beta2-secret.json",
        ...
        ).persist_tokens_to_disk(format!("{}/deploymentmanager2-beta2", config_dir)).build().await.unwrap();
