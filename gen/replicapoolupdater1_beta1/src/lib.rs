...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/replicapoolupdater1_beta1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](Replicapoolupdater) ... 
//! 
//! * [rolling updates](api::RollingUpdate)
//!  * [*cancel*](api::RollingUpdateCancelCall), [*get*](api::RollingUpdateGetCall), [*insert*](api::RollingUpdateInsertCall), [*list*](api::RollingUpdateListCall), [*list instance updates*](api::RollingUpdateListInstanceUpdateCall), [*pause*](api::RollingUpdatePauseCall), [*resume*](api::RollingUpdateResumeCall) and [*rollback*](api::RollingUpdateRollbackCall)
//! * zone operations
//!  * [*get*](api::ZoneOperationGetCall) and [*list*](api::ZoneOperationListCall)
//! 
//! 
//! 
//! 
...
pub use api::Replicapoolupdater;
