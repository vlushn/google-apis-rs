...
use google_cloudresourcemanager1_beta1::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "cloudresourcemanager1-beta1-secret.json",
        ...
        ).persist_tokens_to_disk(format!("{}/cloudresourcemanager1-beta1", config_dir)).build().await.unwrap();
