...
/// * [transfer location locations](LocationTransferLocationCall) (response)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// The list links the activity name, along with information about where it is used (one of *request* and *response*).
/// 
/// * [transfer location locations](LocationTransferLocationCall) (request)
/// 
#[derive(Default, Clone, Debug, Serialize, Deserialize)]
...
/// let mut hub = MyBusinessAccountManagement::new(hyper::Client::builder().build(hyper_rustls::HttpsConnector::with_native_roots()), auth);
/// // Usually you wouldn't bind this to a variable, but keep calling *CallBuilders*
/// // like `admins_create(...)`, `admins_delete(...)`, `admins_list(...)`, `admins_patch(...)` and `transfer_location(...)`
/// // to build up your call.
...
impl<'a> LocationMethods<'a> {
    ...
    ///
    /// * `request` - No description provided.
    /// * `locationsId` - No description provided.
    pub fn transfer_location(&self, request: TransferLocationRequest, locations_id: &str) -> LocationTransferLocationCall<'a> {
        LocationTransferLocationCall {
            hub: self.hub,
            _request: request,
...
impl<'a> AccountAdminCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Admin)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.admins.create",
...
impl<'a> AccountAdminDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.admins.delete",
...
impl<'a> AccountAdminListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListAccountAdminsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.admins.list",
...
impl<'a> AccountAdminPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Admin)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.admins.patch",
...
impl<'a> AccountInvitationAcceptCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.invitations.accept",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> AccountInvitationDeclineCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.invitations.decline",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> AccountInvitationListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListInvitationsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.invitations.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
...
impl<'a> AccountCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Account)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
...
impl<'a> AccountGetCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Account)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.get",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> AccountListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListAccountsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        if let Some(value) = self._parent_account {
            params.push(("parentAccount", value.to_string()));
        }
...
impl<'a> AccountPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Account)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.accounts.patch",
                               http_method: hyper::Method::PATCH });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(6 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
...
impl<'a> LocationAdminCreateCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Admin)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.locations.admins.create",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
impl<'a> LocationAdminDeleteCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.locations.admins.delete",
                               http_method: hyper::Method::DELETE });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        for &field in ["alt", "name"].iter() {
...
impl<'a> LocationAdminListCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, ListLocationAdminsResponse)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.locations.admins.list",
                               http_method: hyper::Method::GET });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(3 + self._additional_params.len());
        params.push(("parent", self._parent.to_string()));
        for &field in ["alt", "parent"].iter() {
...
impl<'a> LocationAdminPatchCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Admin)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.locations.admins.patch",
                               http_method: hyper::Method::PATCH });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(5 + self._additional_params.len());
        params.push(("name", self._name.to_string()));
        if let Some(value) = self._update_mask {
...
/// Moves a location from an account that the user owns to another account that the same user administers. The user must be an owner of the account the location is currently associated with and must also be at least a manager of the destination account.
///
/// A builder for the *transferLocation* method supported by a *location* resource.
/// It is not used directly, but through a `LocationMethods` instance.
///
/// # Example
///
...
/// // execute the final call using `doit()`.
/// // Values shown here are possibly random and not representative !
/// let result = hub.locations().transfer_location(req, "locationsId")
///              .doit().await;
/// # }
/// ```
pub struct LocationTransferLocationCall<'a>
    where  {
...
impl<'a> client::CallBuilder for LocationTransferLocationCall<'a> {}

impl<'a> LocationTransferLocationCall<'a> {
    ...
    pub async fn doit(mut self) -> client::Result<(hyper::Response<hyper::body::Body>, Empty)> {
        ...
        dlg.begin(client::MethodInfo { id: "mybusinessaccountmanagement.locations.transferLocation",
                               http_method: hyper::Method::POST });
        let mut params: Vec<(&str, String)> = Vec::with_capacity(4 + self._additional_params.len());
        params.push(("locationsId", self._locations_id.to_string()));
        for &field in ["alt", "locationsId"].iter() {
            if self._additional_params.contains_key(field) {
                dlg.finished(false);
                return Err(client::Error::FieldClash(field));
            }
        ...
        let mut url = self.hub._base_url.clone() + "v1/locations/{locationsId}:transferLocation";
        ...
        for &(find_this, param_name) in [("{locationsId}", "locationsId")].iter() {
        ...
        {
            let mut indices_for_removal: Vec<usize> = Vec::with_capacity(1);
            for param_name in ["locationsId"].iter() {
                if let Some(index) = params.iter().position(|t| &t.0 == param_name) {
                    indices_for_removal.push(index);
                }
            }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: TransferLocationRequest) -> LocationTransferLocationCall<'a> {
        self._request = new_value;
        self
    }
    ///
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn locations_id(mut self, new_value: &str) -> LocationTransferLocationCall<'a> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn client::Delegate) -> LocationTransferLocationCall<'a> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> LocationTransferLocationCall<'a>
                                                        where T: AsRef<str> {
        self._additional_params.insert(name.as_ref().to_string(), value.as_ref().to_string());
        self
    }
