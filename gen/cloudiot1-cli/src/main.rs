...
use google_cloudiot1::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
    ...
    async fn _projects_locations_registries_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::DeviceRegistry = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_registries_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_registries_devices_create(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut call = self.hub.projects().locations_registries_devices_create(request, opt.value_of("parent").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_registries_devices_modify_cloud_to_device_config(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut call = self.hub.projects().locations_registries_devices_modify_cloud_to_device_config(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_registries_devices_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::Device = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_registries_devices_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "update-mask" => {
    ...
    async fn _projects_locations_registries_get_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut call = self.hub.projects().locations_registries_get_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_registries_patch(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::DeviceRegistry = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_registries_patch(request, opt.value_of("name").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "update-mask" => {
    ...
    async fn _projects_locations_registries_set_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::SetIamPolicyRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_registries_set_iam_policy(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
    ...
    async fn _projects_locations_registries_test_iam_permissions(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::TestIamPermissionsRequest = json::value::from_value(object).unwrap();
        let mut call = self.hub.projects().locations_registries_test_iam_permissions(request, opt.value_of("resource").unwrap_or(""));
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                _ => {
...
async fn main() {
    ...
    let arg_data = [
        ("projects", "methods: 'locations-registries-bind-device-to-gateway', 'locations-registries-create', 'locations-registries-delete', 'locations-registries-devices-config-versions-list', 'locations-registries-devices-create', 'locations-registries-devices-delete', 'locations-registries-devices-get', 'locations-registries-devices-list', 'locations-registries-devices-modify-cloud-to-device-config', 'locations-registries-devices-patch', 'locations-registries-devices-send-command-to-device', 'locations-registries-devices-states-list', 'locations-registries-get', 'locations-registries-get-iam-policy', 'locations-registries-groups-devices-list', 'locations-registries-groups-get-iam-policy', 'locations-registries-groups-set-iam-policy', 'locations-registries-groups-test-iam-permissions', 'locations-registries-list', 'locations-registries-patch', 'locations-registries-set-iam-policy', 'locations-registries-test-iam-permissions' and 'locations-registries-unbind-device-from-gateway'", vec![
            ...
            ("locations-registries-delete",
                    Some(r##"Deletes a device registry configuration."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudiot1_cli/projects_locations-registries-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-registries-devices-create",
                    Some(r##"Creates a device in a device registry."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudiot1_cli/projects_locations-registries-devices-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-registries-devices-delete",
                    Some(r##"Deletes a device."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudiot1_cli/projects_locations-registries-devices-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the device. For example, `projects/p0/locations/us-central1/registries/registry0/devices/device0` or `projects/p0/locations/us-central1/registries/registry0/devices/{num_id}`."##),
            ...
            ("locations-registries-devices-get",
                    Some(r##"Gets details about a device."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudiot1_cli/projects_locations-registries-devices-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the device. For example, `projects/p0/locations/us-central1/registries/registry0/devices/device0` or `projects/p0/locations/us-central1/registries/registry0/devices/{num_id}`."##),
            ...
            ("locations-registries-devices-list",
                    Some(r##"List devices in a device registry."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudiot1_cli/projects_locations-registries-devices-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("locations-registries-devices-patch",
                    Some(r##"Updates a device."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudiot1_cli/projects_locations-registries-devices-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-registries-get",
                    Some(r##"Gets a device registry configuration."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudiot1_cli/projects_locations-registries-get",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The name of the device registry. For example, `projects/example-project/locations/us-central1/registries/my-registry`."##),
            ...
            ("locations-registries-patch",
                    Some(r##"Updates a device registry configuration."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudiot1_cli/projects_locations-registries-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
