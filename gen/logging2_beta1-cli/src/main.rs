...
use google_logging2_beta1::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        ...
        ).persist_tokens_to_disk(format!("{}/logging2-beta1", config_dir)).build().await.unwrap();
    ...
    let arg_data = [
        ("entries", "methods: 'list' and 'write'", vec![
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/entries_list",
                  vec![
                    (Some(r##"kv"##),
                     Some(r##"r"##),
        ...
        ("monitored-resource-descriptors", "methods: 'list'", vec![
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/monitored-resource-descriptors_list",
                  vec![
                    (Some(r##"v"##),
                     Some(r##"p"##),
                     Some(r##"Set various optional parameters, matching the key=value form"##),
        ...
        ("projects", "methods: 'metrics-create', 'metrics-delete', 'metrics-get', 'metrics-list', 'metrics-update', 'sinks-create', 'sinks-delete', 'sinks-get', 'sinks-list' and 'sinks-update'", vec![
            ("metrics-create",
                    Some(r##"Creates a logs-based metric."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/projects_metrics-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        The new metric must be provided in the request."##),
            ...
            ("metrics-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/projects_metrics-delete",
                  vec![
                    (Some(r##"metric-name"##),
                     None,
        ...
        "##),
            ...
            ("metrics-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/projects_metrics-get",
                  vec![
                    (Some(r##"metric-name"##),
                     None,
        ...
        "##),
            ...
            ("metrics-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/projects_metrics-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        "##),
            ...
            ("metrics-update",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/projects_metrics-update",
                  vec![
                    (Some(r##"metric-name"##),
                     None,
        ...
        Examples: "projects/my-logging-project", "organizations/123456789"."##),
            ...
            ("sinks-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/projects_sinks-delete",
                  vec![
                    (Some(r##"sink-name"##),
                     None,
        ...
        Example: "projects/my-project-id/sinks/my-sink-id"."##),
            ...
            ("sinks-get",
                    Some(r##"Gets a sink."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/projects_sinks-get",
                  vec![
                    (Some(r##"sink-name"##),
                     None,
        ...
        Example: "projects/my-project-id/sinks/my-sink-id"."##),
            ...
            ("sinks-list",
                    Some(r##"Lists sinks."##),
                    "Details at http://byron.github.io/google-apis-rs/google_logging2_beta1_cli/projects_sinks-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
