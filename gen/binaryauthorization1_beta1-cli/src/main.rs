...
use google_binaryauthorization1_beta1::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "binaryauthorization1-beta1-secret.json",
        ...
        ).persist_tokens_to_disk(format!("{}/binaryauthorization1-beta1", config_dir)).build().await.unwrap();
    ...
    let arg_data = [
        ("projects", "methods: 'attestors-create', 'attestors-delete', 'attestors-get', 'attestors-get-iam-policy', 'attestors-list', 'attestors-set-iam-policy', 'attestors-test-iam-permissions', 'attestors-update', 'attestors-validate-attestation-occurrence', 'get-policy', 'policy-get-iam-policy', 'policy-set-iam-policy', 'policy-test-iam-permissions' and 'update-policy'", vec![
            ("attestors-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_attestors-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("attestors-delete",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_attestors-delete",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("attestors-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_attestors-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("attestors-get-iam-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_attestors-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("attestors-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_attestors-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
            ...
            ("attestors-test-iam-permissions",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_attestors-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
            ...
            ("attestors-update",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_attestors-update",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("policy-get-iam-policy",
                    Some(r##"Gets the access control policy for a resource. Returns an empty policy if the resource exists and does not have a policy set."##),
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_policy-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being requested. See the operation documentation for the appropriate value for this field."##),
            ...
            ("policy-test-iam-permissions",
                    Some(r##"Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning."##),
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_policy-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy detail is being requested. See the operation documentation for the appropriate value for this field."##),
            ...
            ("update-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/projects_update-policy",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        ("systempolicy", "methods: 'get-policy'", vec![
            ("get-policy",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_binaryauthorization1_beta1_cli/systempolicy_get-policy",
                  vec![
                    (Some(r##"name"##),
                     None,
