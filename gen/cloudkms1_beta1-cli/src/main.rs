...
use google_cloudkms1_beta1::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["create-time", "destroy-event-time", "destroy-time", "name", "next-rotation-time", "primary", "purpose", "rotation-period", "state"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
                ...
                _ => {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["crypto-key-id"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "cloudkms1-beta1-secret.json",
    ...
    let arg_data = [
        ("projects", "methods: 'locations-get', 'locations-key-rings-create', 'locations-key-rings-crypto-keys-create', 'locations-key-rings-crypto-keys-crypto-key-versions-create', 'locations-key-rings-crypto-keys-crypto-key-versions-destroy', 'locations-key-rings-crypto-keys-crypto-key-versions-get', 'locations-key-rings-crypto-keys-crypto-key-versions-list', 'locations-key-rings-crypto-keys-crypto-key-versions-patch', 'locations-key-rings-crypto-keys-crypto-key-versions-restore', 'locations-key-rings-crypto-keys-decrypt', 'locations-key-rings-crypto-keys-encrypt', 'locations-key-rings-crypto-keys-get', 'locations-key-rings-crypto-keys-get-iam-policy', 'locations-key-rings-crypto-keys-list', 'locations-key-rings-crypto-keys-patch', 'locations-key-rings-crypto-keys-set-iam-policy', 'locations-key-rings-crypto-keys-test-iam-permissions', 'locations-key-rings-crypto-keys-update-primary-version', 'locations-key-rings-get', 'locations-key-rings-get-iam-policy', 'locations-key-rings-list', 'locations-key-rings-set-iam-policy', 'locations-key-rings-test-iam-permissions' and 'locations-list'", vec![
            ("locations-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-key-rings-create",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The resource name of the location associated with the
        ...
        CryptoKey.purpose is required."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
        ...
        CryptoKeys."##),
            ...
            ("locations-key-rings-crypto-keys-crypto-key-versions-create",
                    Some(r##"Create a new CryptoKeyVersion in a CryptoKey.
        
        The server will assign the next sequential id. If unset,
        state will be set to
        ENABLED."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-crypto-key-versions-create",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The name of the CryptoKey associated with
        the CryptoKeyVersions."##),
            ...
            ("locations-key-rings-crypto-keys-crypto-key-versions-destroy",
                    Some(r##"Schedule a CryptoKeyVersion for destruction.
        ...
        RestoreCryptoKeyVersion may be called to reverse the process."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-crypto-key-versions-destroy",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-key-rings-crypto-keys-crypto-key-versions-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-crypto-key-versions-get",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-key-rings-crypto-keys-crypto-key-versions-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-crypto-key-versions-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The resource name of the CryptoKey to list, in the format
        `projects/*/locations/*/keyRings/*/cryptoKeys/*`."##),
            ...
            ("locations-key-rings-crypto-keys-crypto-key-versions-patch",
                    Some(r##"Update a CryptoKeyVersion's metadata.
        ...
        move between other states."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-crypto-key-versions-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. The resource name for this CryptoKeyVersion in the format
        ...
        and destroy_time will be cleared."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-crypto-key-versions-restore",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-key-rings-crypto-keys-decrypt",
                    Some(r##"Decrypt data that was protected by Encrypt."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-decrypt",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the CryptoKey to use for decryption.
        The server will choose the appropriate version."##),
            ...
            ("locations-key-rings-crypto-keys-encrypt",
                    Some(r##"Encrypt data, so that it can only be recovered by a call to Decrypt."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-encrypt",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Required. The resource name of the CryptoKey or CryptoKeyVersion
        ...
        primary version."##),
            ...
            ("locations-key-rings-crypto-keys-get",
                    Some(r##"Returns metadata for a given CryptoKey, as well as its
        primary CryptoKeyVersion."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        set."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
        ...
        See the operation documentation for the appropriate value for this field."##),
            ...
            ("locations-key-rings-crypto-keys-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The resource name of the KeyRing to list, in the format
        `projects/*/locations/*/keyRings/*`."##),
            ...
            ("locations-key-rings-crypto-keys-patch",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-patch",
                  vec![
                    (Some(r##"name"##),
                     None,
                     Some(r##"Output only. The resource name for this CryptoKey in the format
        `projects/*/locations/*/keyRings/*/cryptoKeys/*`."##),
                     Some(true),
                     Some(false)),
        ...
        existing policy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
        ...
        may "fail open" without warning."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
        ...
        See the operation documentation for the appropriate value for this field."##),
            ...
            ("locations-key-rings-crypto-keys-update-primary-version",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-crypto-keys-update-primary-version",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("locations-key-rings-get",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-get",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        Returns an empty policy if the resource exists and does not have a policy
        set."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being requested.
        See the operation documentation for the appropriate value for this field."##),
            ...
            ("locations-key-rings-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-list",
                  vec![
                    (Some(r##"parent"##),
                     None,
                     Some(r##"Required. The resource name of the location associated with the
        KeyRings, in the format `projects/*/locations/*`."##),
            ...
            ("locations-key-rings-set-iam-policy",
                    Some(r##"Sets the access control policy on the specified resource. Replaces any
        existing policy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy is being specified.
        ...
        UIs and command-line tools, not for authorization checking. This operation
        may "fail open" without warning."##),
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-key-rings-test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
                     Some(r##"REQUIRED: The resource for which the policy detail is being requested.
        See the operation documentation for the appropriate value for this field."##),
            ...
            ("locations-list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_cloudkms1_beta1_cli/projects_locations-list",
                  vec![
                    (Some(r##"name"##),
                     None,
