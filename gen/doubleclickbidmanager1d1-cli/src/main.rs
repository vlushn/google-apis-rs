...
use google_doubleclickbidmanager1d1::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
    async fn _lineitems_downloadlineitems(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::DownloadLineItemsRequest = json::value::from_value(object).unwrap();
    ...
    async fn _lineitems_uploadlineitems(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::UploadLineItemsRequest = json::value::from_value(object).unwrap();
    ...
    async fn _queries_createquery(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
        ...
        let mut request: api::Query = json::value::from_value(object).unwrap();
        let mut call = self.hub.queries().createquery(request);
        for parg in opt.values_of("v").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            let (key, value) = parse_kv_arg(&*parg, err, false);
            match key {
                "asynchronous" => {
                    call = call.asynchronous(arg_from_str(value.unwrap_or("false"), err, "asynchronous", "boolean"));
                },
                _ => {
                    let mut found = false;
                    for param in &self.gp {
                    ...
                    if !found {
                        err.issues.push(CLIError::UnknownParameter(key.to_string(),
                                                                  {let mut v = Vec::new();
                                                                           v.extend(self.gp.iter().map(|v|*v));
                                                                           v.extend(["asynchronous"].iter().map(|v|*v));
                                                                           v } ));
                    }
                }
            }
    ...
    let arg_data = [
        ...
        ("queries", "methods: 'createquery', 'deletequery', 'getquery', 'listqueries' and 'runquery'", vec![
            ("createquery",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_doubleclickbidmanager1d1_cli/queries_createquery",
                  vec![
                    (Some(r##"kv"##),
                     Some(r##"r"##),
                     Some(r##"Set various fields of the request structure, matching the key=value form"##),
            ...
            ("deletequery",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_doubleclickbidmanager1d1_cli/queries_deletequery",
                  vec![
                    (Some(r##"query-id"##),
                     None,
            ...
            ("getquery",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_doubleclickbidmanager1d1_cli/queries_getquery",
                  vec![
                    (Some(r##"query-id"##),
                     None,
            ...
            ("listqueries",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_doubleclickbidmanager1d1_cli/queries_listqueries",
                  vec![
                    (Some(r##"v"##),
                     Some(r##"p"##),
                     Some(r##"Set various optional parameters, matching the key=value form"##),
            ...
            ("runquery",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_doubleclickbidmanager1d1_cli/queries_runquery",
                  vec![
                    (Some(r##"query-id"##),
                     None,
        ...
        ("reports", "methods: 'listreports'", vec![
            ("listreports",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_doubleclickbidmanager1d1_cli/reports_listreports",
                  vec![
                    (Some(r##"query-id"##),
                     None,
        ...
        ("sdf", "methods: 'download'", vec![
            ("download",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_doubleclickbidmanager1d1_cli/sdf_download",
                  vec![
                    (Some(r##"kv"##),
                     Some(r##"r"##),
                     Some(r##"Set various fields of the request structure, matching the key=value form"##),
