...
use google_servicebroker1::{api, Error, oauth2};
...
impl<'n> Engine<'n> {
    async fn _methods_get_iam_policy(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        let mut call = self.hub.methods().get_iam_policy(opt.value_of("resource").unwrap_or(""));
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "servicebroker1-secret.json",
...
async fn main() {
    ...
    let arg_data = [
        ...
        set."##),
                    "Details at http://byron.github.io/google-apis-rs/google_servicebroker1_cli/methods_get-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
        ...
        existing policy."##),
                    "Details at http://byron.github.io/google-apis-rs/google_servicebroker1_cli/methods_set-iam-policy",
                  vec![
                    (Some(r##"resource"##),
                     None,
        ...
        may "fail open" without warning."##),
                    "Details at http://byron.github.io/google-apis-rs/google_servicebroker1_cli/methods_test-iam-permissions",
                  vec![
                    (Some(r##"resource"##),
                     None,
    ...
    let mut app = App::new("servicebroker1")
           ...
           .version("2.0.9+20190624")
           .about("The Google Cloud Platform Service Broker API provides Google hosted
           implementation of the Open Service Broker API
           (https://www.openservicebrokerapi.org/).
           ")
           .after_help("All documentation details can be found at http://byron.github.io/google-apis-rs/google_servicebroker1_cli")
