        ...
        for kvarg in opt.values_of("kv").map(|i|i.collect()).unwrap_or(Vec::new()).iter() {
            ...
            let type_info: Option<(&'static str, JsonTypeInfo)> =
                match &temp_cursor.to_string()[..] {
                    ...
                    _ => {
                        let suggestion = FieldCursor::did_you_mean(key, &vec!["code", "content", "error", "inline-document", "message", "mime-type", "shard-count", "shard-index", "shard-info", "text", "text-offset", "uri"]);
                        err.issues.push(CLIError::Field(FieldError::Unknown(temp_cursor.to_string(), suggestion, value.map(|v| v.to_string()))));
                        None
                    }
                };
    ...
    let arg_data = [
        ("operations", "methods: 'cancel', 'delete' and 'list'", vec![
            ("cancel",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_documentai1_cli/operations_cancel",
                  vec![
                    (Some(r##"name"##),
                     None,
            ...
            ("list",
                    ...
                    "Details at http://byron.github.io/google-apis-rs/google_documentai1_cli/operations_list",
                  vec![
                    (Some(r##"name"##),
                     None,
        ...
        ("projects", "methods: 'locations-get', 'locations-list', 'locations-operations-get', 'locations-processors-batch-process', 'locations-processors-human-review-config-review-document', 'locations-processors-process', 'locations-processors-processor-versions-batch-process', 'locations-processors-processor-versions-process' and 'operations-get'", vec![
            ("locations-get",
        ...
        ("uiv1beta3", "methods: 'projects-locations-get', 'projects-locations-list' and 'projects-locations-operations-get'", vec![
