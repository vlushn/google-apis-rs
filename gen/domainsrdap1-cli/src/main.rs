...
use google_domainsrdap1::{api, Error, oauth2};
...
async fn main() {
    ...
    let arg_data = [
        ...
        ("domain", "methods: 'get'", vec![
            ("get",
                    Some(r##"Look up RDAP information for a domain by name."##),
                    "Details at http://byron.github.io/google-apis-rs/google_domainsrdap1_cli/domain_get",
                  vec![
                    (Some(r##"domain-name"##),
                     None,
                     Some(r##"Full domain name to look up. Example: "example.com""##),
                     Some(true),
                     Some(false)),
        ...
        ("methods", "methods: 'get-domains', 'get-entities', 'get-help', 'get-ip' and 'get-nameservers'", vec![
            ...
            ("get-help",
                    Some(r##"Get help information for the RDAP API, including links to documentation."##),
                    "Details at http://byron.github.io/google-apis-rs/google_domainsrdap1_cli/methods_get-help",
                  vec![
                    (Some(r##"v"##),
                     Some(r##"p"##),
                     Some(r##"Set various optional parameters, matching the key=value form"##),
