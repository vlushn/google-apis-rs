...
impl<'n> Engine<'n> {
    async fn _documents_analyze_entities(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
    ...
    async fn _documents_analyze_entity_sentiment(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::AnalyzeEntitySentimentRequest = json::value::from_value(object).unwrap();
    ...
    async fn _documents_analyze_sentiment(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::AnalyzeSentimentRequest = json::value::from_value(object).unwrap();
    ...
    async fn _documents_analyze_syntax(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::AnalyzeSyntaxRequest = json::value::from_value(object).unwrap();
    ...
    async fn _documents_annotate_text(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::AnnotateTextRequest = json::value::from_value(object).unwrap();
    ...
    async fn _documents_classify_text(&self, opt: &ArgMatches<'n>, dry_run: bool, err: &mut InvalidOptionsError)
                                                    -> Result<(), DoitError> {
        ...
        let mut request: api::ClassifyTextRequest = json::value::from_value(object).unwrap();
            ...
            ("documents", Some(opt)) => {
                match opt.subcommand() {
                    ("analyze-entities", Some(opt)) => {
                        call_result = self._documents_analyze_entities(opt, dry_run, &mut err).await;
                    },
                    ("analyze-entity-sentiment", Some(opt)) => {
                        call_result = self._documents_analyze_entity_sentiment(opt, dry_run, &mut err).await;
                    },
                    ("analyze-sentiment", Some(opt)) => {
                        call_result = self._documents_analyze_sentiment(opt, dry_run, &mut err).await;
                    },
    ...
    async fn new(opt: ArgMatches<'n>) -> Result<Engine<'n>, InvalidOptionsError> {
        let (config_dir, secret) = {
            ...
            match client::application_secret_from_directory(&config_dir, "language1-secret.json",
