...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/playmoviespartner1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](PlayMovies) ... 
//! 
//! * accounts
//!  * [*avails get*](api::AccountAvailGetCall), [*avails list*](api::AccountAvailListCall), [*orders get*](api::AccountOrderGetCall), [*orders list*](api::AccountOrderListCall), [*store infos country get*](api::AccountStoreInfoCountryGetCall) and [*store infos list*](api::AccountStoreInfoListCall)
//! 
//! 
//! 
//! 
