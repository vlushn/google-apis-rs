...
//! * [landing pages](api::LandingPage)
//!  * [*delete*](api::LandingPageDeleteCall), [*get*](api::LandingPageGetCall), [*insert*](api::LandingPageInsertCall), [*list*](api::LandingPageListCall), [*patch*](api::LandingPagePatchCall) and [*update*](api::LandingPageUpdateCall)
