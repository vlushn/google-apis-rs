...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/urlshortener1).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](Urlshortener) ... 
//! 
//! * [url](api::Url)
//!  * [*get*](api::UrlGetCall), [*insert*](api::UrlInsertCall) and [*list*](api::UrlListCall)
//! 
//! 
//! 
//! 
