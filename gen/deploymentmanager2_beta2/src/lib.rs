...
//! The original source code is [on github](https://github.com/Byron/google-apis-rs/tree/main/gen/deploymentmanager2_beta2).
//! # Features
//! 
//! Handle the following *Resources* with ease from the central [hub](DeploymentManager) ... 
//! 
//! * [deployments](api::Deployment)
//!  * [*delete*](api::DeploymentDeleteCall), [*get*](api::DeploymentGetCall), [*insert*](api::DeploymentInsertCall), [*list*](api::DeploymentListCall), [*patch*](api::DeploymentPatchCall) and [*update*](api::DeploymentUpdateCall)
